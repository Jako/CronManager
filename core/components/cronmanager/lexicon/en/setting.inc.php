...
$_lang['setting_cronmanager.daylight_saving'] = 'Consider Daylight Saving';
$_lang['setting_cronmanager.daylight_saving_desc'] = 'When calculating the next run of the cron job, take daylight saving time into account (only used if the interval between two runs is greater than 60 minutes)';
