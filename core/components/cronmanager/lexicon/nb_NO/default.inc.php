...
$_lang['cronmanager.cronjobs_desc'] = 'Below you can add, modify or remove cronjob actions. Remember these cronjob actions are only working if the setup of the CronManager is followed successfull! See the documentation (or help button) for more details.';
$_lang['cronmanager.lastrun'] = 'Last run';
$_lang['cronmanager.minutes'] = 'Minutes';
$_lang['cronmanager.minutes_desc'] = 'The number of minutes of the interval this snippet has to be executed. Minimum value is 1 minute.';
...
$_lang['cronmanager.logs_purge_confirm'] = 'Are you sure you want to purge this cronjob\'s logs without error?<br><br><span class="red">Warning:</span> Make sure your snippet/job correctly defines the error \'status\', otherwise all your logs for this job will be wiped.';
