...
$_lang['cronmanager.log_cronjob_err_ns'] = 'Aucun ID de cronjob de défini.';
...
$_lang['cronmanager.logs_purge_confirm'] = 'Êtes-vous sûr de vouloir purger les logs sans erreur de ce cronjob ?<br><br><span class="red">Attention:</span> Assurez-vous que votre snippet définisse correctement le « statut » des erreurs, sinon tous les logs de ce cronjob seront purgés.';
