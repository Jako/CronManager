<?php
/**
 * Logs Manager Controller class for CronManager
 *
 * @package cronmanager
...
/**
 * Class CronManagerLogsManagerController
 */
class CronManagerLogsManagerController extends modExtraManagerController
{
