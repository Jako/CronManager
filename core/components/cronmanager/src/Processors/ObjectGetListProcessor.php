...
class ObjectGetListProcessor extends modObjectGetListProcessor
{
    ...
    {
        if (file_exists($this->cronmanager->getOption('corePath') . 'lexicon/' . $this->modx->getOption('manager_language', [], 'en') . '/custom.inc.php')) {
            $this->languageTopics[] = 'cronmanager:custom';
        }
